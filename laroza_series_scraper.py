...
async def scrape_laroza_series(max_pages=None):
    ...
    try:
        async with async_playwright() as p:
            ...
            # 2. منع تحميل الصور لتسريع السحب بنسبة كبيرة (تحسين أداء)
            await page.route(
                ...
                try:
                    ...
                    for item in items:
                        try:
                            ...
                            # محاولة استخراج السنة من العنوان إن وجدت
        ...
        # --- التحسين رقم 2: قتل العمليات المعلقة (تنظيف الرام) ---
        if browser_instance:
        ...
        if all_series:
            ...
            for i in range(0, total_count, chunk_size):
                ...
                filename = f"laroza_series_part{part_num}.json"
